...
def train(hyp, opt, device, callbacks):
    ...
    hyp["sz"] *= (imgsz / 640) ** 2 * 3 / nl  # scale to image size and layers
    hyp["ctr"] *= (imgsz / 640) ** 2 * 3 / nl  # scale to image size and layers
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        meta = {
            ...
            "ar": (False, 0.02, 0.2),  # ar loss gain
            "ctr": (False, 0.002, 0.02),  # ar loss gain
            "sz": (False, 0.0002, 0.002),  # ar loss gain
